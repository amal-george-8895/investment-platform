    ...
    <div class="row">
        ...
        <div class="col-md-6 mt-0  mb-0 pb-0" style="height:500px;" >
            <div style="color: #0d6efd;text-align: center;">
                <h3 class="grid2h3">Client Registration Form</h3>
            </div>
            <form style="margin-left:15%" name="registerForm" onsubmit="return validation()" action="scripts/clientregister.php" method="POST">
...
<script>
    function validation()//validates if the fields are not null
    {
