      ...
      <div class="col-md-6 mt-0  mb-0 pb-0" style="height:500px;">
        <nav>
          <div class="nav nav-tabs" id="nav-tab" role="tablist">
            <a class="nav-link" href="../index.php" type="button">Admin</a>
            <a class="nav-link active" href="index.php" type="button">RM</a>
        ...
        <div class="tab-content" id="nav-tabContent">
          <div style="color: #0d6efd; ">
            <div style="color: #0d6efd;" class="text-center my-4">
              <h3 class="grid2h3">RM LOGIN</h3>
            </div>
            <form name="f1" action="scripts/rmlogin.php" onsubmit="return validation()" method="POST"
            ...
            <div class="row d-flex justify-content-center">
              <button type="button" onclick="window.location.href = 'rmregistration.php';"
                class="btn btn-primary w-50 my-3">Register for New RM</button>
            </div>
