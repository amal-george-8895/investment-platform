            ...
            <div class="section">
                <div class="content">
                    <div class="row text-center">
                        <h3 style="color:#0d6efd;">Products</h3>
                    </div>
                    ...
                    <div class="row my-4">
                        <div class="row">
                            <?php
                            include 'db_conn.php';
                            $sql = "SELECT * FROM `products`"; //query to select all the products
                            if(isset($_POST['submit'])) {
                                $name = $_POST['by_name']; //stores by_name in $name
                                if ($name == ''){
                            ...
                            $result = $con->query($sql);//query is executed and result is stored in this variable
                            if($result)
                            {
