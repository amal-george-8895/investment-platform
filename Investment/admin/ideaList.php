                ...
                <div class="content">
                    ...
                    <div class="row my-4">
                        ...
                        <div class="row">
                            <?php
                            include 'db_conn.php';
                            $sql = "SELECT * FROM `ideas`";//selects all the columns from the ideas
                                    ...
                                    while($row = $result->fetch_assoc())
                                    {
                                        ...
                                        echo "<div class=\"col-4 my-2\">
                                                <div class=\"card\" >
                                                 ...
                                                 <a href='scripts/deleteIdea.php?id=$id' style='text-align-last: end;color: red;font-size: 18px;'><p>Delete</p></a>
