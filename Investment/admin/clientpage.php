            ...
            <div class="section">
                <div class="content">
                    <div class="row text-center">
                        <h3 style="color:#0d6efd;">OUR CLIENTS</h3>
                    </div>
                    <div class="row my-4">
                        <div class="row">
                            <?php
                            include 'db_conn.php';
                            $id = $_SESSION['id'];
                            $sql = "SELECT * FROM `user` where role='client'";//select the users with a role of client from database
                            $result = $con->query($sql);//stores the query in $result variable
                            if($result)
                            {
                                    ...
                                    while($row = $result->fetch_assoc())
                                    {
                                        ...
                                        echo "<div class=\"col-4 mt-2\">
                                                <div class=\"card\" >
                                                 <div class=\"card-body\">
                                                  <h5 class=\"card-title\"> 
                                                  <a href=\"profile.php?userId=$id\">". $row['fname'].' '.$row['lname'] ."</a></h5>
